...
from flaskblog.forms import (Registrationform, Loginform,
                             UpadteAccountform, PostForm, RequestResetForm, ResetPasswordForm)
...
def home():
    ...
    return render_template('home.html', posts=posts, title="post")
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            flash("Your email or password is invalid!", "danger")
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request', sender='princesuriya14@gmail.com', recipients=[user.email])
    msg.body = f''' TO reset your password visit the following link:
{url_for('reset_token', _external=True, token=token)}
